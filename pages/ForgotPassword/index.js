  ...
  return (
    ...
    <div>
        <div className="login-card">
            ...
            <Button variant="contained" component="span" fullWidth style={{marginTop:"1rem"}} onClick={handleClick} disabled={loading}>Send Email</Button>
            {/* <div style={{color:"blue", marginTop:"1rem"}} >Forgot Password</div> */}
        </div>
